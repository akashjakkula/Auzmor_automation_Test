...
public class Main {
    public static void main(String[] args) throws Throwable{
        ...
        System.setProperty("web-driver.chrome.driver","C:\\Users\\91889\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
...
//        driver.findElement(By.xpath("//div[@class='absolute bg-white rounded-full p-[5px] cursor-pointer top-1 right-1']")).click();
        ...
        fileInput.sendKeys("C:\\Users\\91889\\OneDrive\\Pictures\\download123.png");
        ...
        driver.get(imageSrc);
        Thread.sleep(5000);
        File image = new File("C:\\Users\\91889\\OneDrive\\Pictures\\download123.png");
        BufferedImage expectedImage = ImageIO.read(image);
        String OldImagePath = "C:\\Users\\91889\\Downloads";
        try {
